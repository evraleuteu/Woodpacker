...
SCHEMA_PATH = Path('C:/Users/leute/OneDrive/Bureau/Dev/Woodpacker/extraction-service/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'windows': 'C:\\Users\\leute\\.cache\\prisma-python\\binaries\\5.17.0\\393aa359c9ad4a4bb28630fb5613f9c281cde053\\node_modules\\prisma\\query-engine-windows.exe'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    lessonmaterialfile: 'actions.LessonMaterialFileActions[models.LessonMaterialFile]'
    lessonmateriallink: 'actions.LessonMaterialLinkActions[models.LessonMaterialLink]'
    ...
    def __init__(
        ...
        *,
        ...
        self.lessonmaterialfile = actions.LessonMaterialFileActions[models.LessonMaterialFile](self, models.LessonMaterialFile)
        self.lessonmateriallink = actions.LessonMaterialLinkActions[models.LessonMaterialLink](self, models.LessonMaterialLink)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': 'C:/Users/leute/OneDrive/Bureau/Dev/Woodpacker/extraction-service/prisma/schema.prisma',
        }
...
class Batch:
    ...
    lessonmaterialfile: 'LessonMaterialFileBatchActions'
    lessonmateriallink: 'LessonMaterialLinkBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.lessonmaterialfile = LessonMaterialFileBatchActions(self)
        self.lessonmateriallink = LessonMaterialLinkBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class LessonMaterialFileBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
    ...
    def create(
        ...
        self._batcher._add(
            method='create',
            model=models.LessonMaterialFile,
            arguments={
                'data': data,
                'include': include,
            },
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class LessonMaterialLinkBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
    ...
    def create(
        ...
        self._batcher._add(
            method='create',
            model=models.LessonMaterialLink,
            arguments={
                'data': data,
                'include': include,
            },
